...
class Game:
    ...
    def draw_text(self, screen, msg, y ,fsize, color):
        ...
        text_rect = text.get_rect(center=(int(self.w/2), y))
    ...
    def show_results(self, screen):
        if(not self.end):
            #Calculate time
            self.total_time = time.perf_counter() - self.time_start
        ...
        while(self.running):
            ...
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    ...
                    if(x>=310 and x<=480 and y>=390 and self.end):
                        self.reset_game()
                        x,y = pygame.mouse.get_pos()
    ...
    def reset_game(self):
        ...
        note = '* Click on the Text Box before typing to get accurate details!!!'
